...
const IndexPage = () => (
  <Layout>
    ...
    <div>
      <H4>About Me</H4>
      <Body1>
        I'm a Technological Engineer, and a Student at the University of
        Edinburgh. I'm currently studying
        {` `}
        <ExternalLink href="http://www.drps.ed.ac.uk/17-18/dpt/utaisen.htm">
          Artificial Intelligence and Software Engineering
        </ExternalLink>
        , and have previously studied Electrical and Mechanical Engineering.
      ...
      <Body1>
        ...
        — a cloud-based, SaaS company based in Edinburgh, developing software
        for training providers.
      </Body1>
      <Body1>
        I have a massive passion for engineering, technology, programming and
        artificial intelligence; and I have previously volunteered as a{` `}
        <ExternalLink href="https://www.icanresearch.com/">
          Technological Engineer at the International Children’s Advisory
          Network (iCAN Research)
        </ExternalLink>
